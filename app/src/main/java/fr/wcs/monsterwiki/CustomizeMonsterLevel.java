    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suivant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String condition = nom.getStringExtra("condition");

                Intent type = getIntent();
                int element = type.getIntExtra("element",0);
                ...
                CustomizeMonsterLevelToYourMonster.putExtra("condition",condition);
                CustomizeMonsterLevelToYourMonster.putExtra("element",element);
